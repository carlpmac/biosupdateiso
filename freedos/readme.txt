...
FreeDOS 1.1 Final is offered for:
...
80386 or newer   : - download the bootable freedos installer cdrom
                     http://www.ibiblio.org/pub/micro/pc-stuff/freedos/files/distributions/1.1/fd??????.iso
...
| KERNEL.SYS         FreeDOS kernel, version 2.0.40 or newer
|
...
-The FreeDOS kernel may be updated by replacing C:\KERNEL.SYS with a newer
 version (COPY C:\2041\KERNEL.SYS C:\KERNEL.SYS), which can be obtained from:
...
or compiled (use OpenWatCom 1.9 for example) from sources:
